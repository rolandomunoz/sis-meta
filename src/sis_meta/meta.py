...
class Meta:
    ...
    def _parse(self, path):
        """
        Yield the marks in a meta file.
        ...
        Returns
        -------
        list of tuple, [(position, length, group, text), ...]
            A list of tuple. Each tuple contains: start position, length,
            group_name and group_id and text.
        """
        ...
        return list(zip(positions, lengths, texts, group_ids, group_names))
